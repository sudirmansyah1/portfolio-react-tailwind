...
import character3D from "../../public/assets/3D/character.glb";
import Sitting from "../../public/assets/3D/Sitting.fbx";
...
export function CharacterSeat({selectedAnims, ...props}){
    ...
    const animations = {
        Sitting: useFBX(Sitting).animations,
        Waving: useFBX(Waving).animations,
        // Add more animations here as needed
    };

    const { actions, mixer } = useAnimations(animations.Sitting, group);
...
useGLTF.preload(character3D);
useFBX.preload(Sitting);
